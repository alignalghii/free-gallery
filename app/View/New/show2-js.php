<ul class="upper-menu internal">
			...
			<li><a class="menu-icon" href="/focus2/<?php echo $offerId; ?>/<?php echo $pictureId; ?>">Plain version</a></li>
		</ul>
		<div id="header">
			Igthorn &amp; Toadie Ltd
		</div
...
<?php if ($triagedPicture[0] == 'focus'): ?>
				><a class="slide focus" data-order="<?php echo $i; ?>" data-href="/focus2-js/<?php echo $offerId; ?>/<?php echo $pictureId; ?>"><img id="focus-small" class="fitbox" src="<?php echo $triagedPicture[1]['src']; ?>"/></a
<?php else: ?>
				><a class="slide <?php echo $triagedPicture[0]; ?>" data-order="<?php echo $i; ?>" href="/focus2-js/<?php echo $offerId; ?>/<?php echo $triagedPicture[1]['id']; ?>"><img class="fitbox small" src="<?php echo $triagedPicture[1]['src']; ?>"/></a
<?php endif; ?>
<?php endforeach; ?>
